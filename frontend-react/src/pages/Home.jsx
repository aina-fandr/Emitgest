import { GraduationCap, ShieldCheck, BookOpen, Globe, LayoutDashboard, Send } from 'lucide-react'
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl w-full">
        ...
        <div className="glass-card rounded-3xl p-8 flex flex-col items-center text-center">
          ...
          <p className="text-blue-100/60 text-sm leading-relaxed mb-8 flex-grow">
            Gestion complète des salles, emplois du temps, demandes et professeurs. Accès réservé au personnel administratif.
          </p>
          <button 
        ...
        <div className="glass-card rounded-3xl p-8 flex flex-col items-center text-center">
          ...
          <p className="text-blue-100/60 text-sm leading-relaxed mb-8 flex-grow">
            Créez votre compte, soumettez vos disponibilités et contraintes. Vérification par pièce d'identité requise.
          </p>
          <button className="w-full bg-indigo-600 hover:bg-indigo-500 text-white py-3 rounded-xl font-medium flex items-center justify-center gap-2 transition-colors">
            <GraduationCap className="w-4 h-4" /> Accéder
          </button>
        </div>
        ...
        <div className="glass-card rounded-3xl p-8 flex flex-col items-center text-center">
          ...
          <p className="text-blue-100/60 text-sm leading-relaxed mb-8 flex-grow">
            Demande de réservation de salle pour associations et clubs. Aucune inscription requise, vérification par CIN.
          </p>
          <button className="w-full bg-emerald-600 hover:bg-emerald-500 text-white py-3 rounded-xl font-medium flex items-center justify-center gap-2 transition-colors">
