...
function App() {
  ...
  if (currentView === 'home') {
    return <Home onNavigate={(page) => { setCurrentView('admin'); setCurrentPage(page) }} />
  }
    ...
    <div className="flex h-screen overflow-hidden bg-slate-50">
      <aside className="w-64 bg-white border-r border-slate-200 flex flex-col h-full shrink-0">
        ...
        <div className="p-4 border-t border-slate-100 space-y-2">
          ...
          <button className="w-full flex items-center gap-3 px-4 py-2 text-sm text-slate-500 hover:text-red-600 transition-colors">
